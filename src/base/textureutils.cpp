...
namespace grabbed::base::textureutils
{
    ...
    const char* toString(X360TextureFormat type)
    {
        switch (type)
        {
            ...
            case X360TextureFormat::A8L8:
                return "A8L8";
            case X360TextureFormat::X4R4G4B4:
                return "X4R4G4B4";
    ...
    const char* toString(GenericTextureType type)
    {
        switch (type)
        {
            case GenericTextureType::Unsupported:
                return "unsupported";
            case GenericTextureType::BC1:
                return "BC1 (DXT1)";
            case GenericTextureType::BC2:
                return "BC2 (DXT3)";
            case GenericTextureType::BC3:
                return "BC3 (DXT5)";
            case GenericTextureType::ARGB:
                return "ARGB";
        }
    ...
    GenericTextureType makeGenericType(XboxD3DFormat originalType)
    {
        switch (originalType)
        {
        case XboxD3DFormat::X_D3DFMT_DXT1: return GenericTextureType::BC1;
        case XboxD3DFormat::X_D3DFMT_DXT3: return GenericTextureType::BC2;
        case XboxD3DFormat::X_D3DFMT_DXT5: return GenericTextureType::BC3;
        case XboxD3DFormat::X_D3DFMT_LIN_A8R8G8B8: return GenericTextureType::ARGB;
        }

        return GenericTextureType::Unsupported;
    }
    ...
    GenericTextureType makeGenericType(X360TextureFormat originalType)
    {
        switch (originalType)
        {
        case X360TextureFormat::DXT1: return GenericTextureType::BC1;
        case X360TextureFormat::DXT3: return GenericTextureType::BC2;
        case X360TextureFormat::DXT5: return GenericTextureType::BC3;
        case X360TextureFormat::A8R8G8B8: return GenericTextureType::ARGB;
        }
